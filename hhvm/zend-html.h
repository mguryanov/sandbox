...
enum class EntBitmask {
  ...
  ENT_BM_HTML401 = 0,       /* HTML401 mode*/
  ENT_BM_XML1 = 16,         /* XML1 mode*/
  ENT_BM_XHTML = 32,        /* XHTML mode */
  ENT_BM_HTML5 = (16|32),   /* HTML5 mode */
  ENT_BM_DOC_TYPE = (16|32),/* doctype */
  ENT_BM_DISALLOWED = 128   /* replace invalid code points for the given
                             * document type with a U+FFFD (UTF-8) or &#FFFD;
